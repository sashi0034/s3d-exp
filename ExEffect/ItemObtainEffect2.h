...
namespace ExEffect
{
	...
	private:
		void drawCircleFrame(
			double timeSec, double startSec, double endSec, double r, const ColorF& color) const
		{
		...
		void drawParticle(double timeSec, double startSec, double endSec, double direction, ColorF color) const
		{
			if (InRange(timeSec, startSec, endSec) == false) return;
