...
namespace ExUiBasic
{
	...
	void ItemLabel::SetCenter(const Vec2& point)
	{
		p_impl->center = point;
	}

	void ItemLabel::ShowMessage(const DrawableText& text)
	{
